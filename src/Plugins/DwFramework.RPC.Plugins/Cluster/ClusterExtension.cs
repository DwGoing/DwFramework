...
namespace DwFramework.RPC.Plugins
{
    public static class ClusterExtension
    {
        ...
        /// <returns></returns>
        public static ServiceHost RegisterClusterService(this ServiceHost host, ClusterService.Config config)
        {
            ...
            host.OnInitialized += provider => provider.RunClusterService(config);
            return host;
        }
        ...
        /// <param name="provider"></param>
        /// <param name="config"></param>
        public static void RunClusterService(this IServiceProvider provider, ClusterService.Config config)
        {
